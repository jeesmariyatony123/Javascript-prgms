restuarants =[
    ...
    },
    {
      ...
      photograph: "https://images.unsplash.com/photo-1604382355076-af4b0eb60143?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80",
    ...
    },
    {
      ...
      neighborhood: "Manhattan",
     photograph: "https://images.unsplash.com/photo-1590330813083-fc22d4b6a48c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80",
    ...
    },
    {
      ...
      neighborhood: "Manhattan",
      photograph: "https://images.unsplash.com/photo-1595436252086-7496fb8c41e9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80",
...
console.log("a. all restaurants name:");
restuarants.flat(Infinity).forEach(res=>console.log(res.name))
console.log("============");
console.log("b. operating hours of restaurant id:4");
restuarants.flat(Infinity).filter(res=>res.id===4).forEach(res => console.log(res.operating_hours))
console.log("============");
console.log("c. comments provided by customer Steph for restaurant Emily: ");
restuarants.map(res => res.reviews).flat(Infinity).filter(res=>res.name==="Emily").forEach(res => console.log(res.comments))
console.log("============");
console.log("d. all restaurants name whose cuisine_type is Asian:");
restuarants.flat(Infinity).filter(res=>res.cuisine_type==="Asian").forEach(res => console.log(res.name))
console.log("============");
console.log("e. all restaurants whose neighborhood is Brooklyn:");
restuarants.flat(Infinity).filter(res=>res.neighborhood==="Brooklyn").forEach(res => console.log(res.name))
